...
INSERT INTO `customer_cards` VALUES (30,2),(31,3),(32,5),(33,7),(34,8),(35,9),(36,10),(40,14),(41,16),(42,17);
...
INSERT INTO `passwords` VALUES (2,'$2a$10$OUYz9I1vucc6j4chqc8I2eILgVDTyFv4lvws9Um0Tu6sJaJfEfJ0i','\n\ 5Y\Á%\≈\Œ~\·kÑ','©˘7fQµ≥\‡Q∏îı\‹\ﬂ\œ','2017-03-05 23:37:09',35),(3,'$2a$10$61RSU7cIjWOogiggSTP9duxyPum7oBcffONhLtjPk0WLS0xAi6h7K','\Á\ÌCûòX4Biö6A±P)','nqÖuGzm,$@•õñ©`','2017-03-05 23:48:47',35),(4,'$2a$10$aSvGKE1OVJg6GzBN5xJWRe/6ZfeYGLt0nggykYdatvksjtkm1xejO','±\Ï(yêG}£7°X\÷`S','vaWàß^+êˆhì.Ñ','2017-03-07 23:00:18',36),(5,'$2a$10$DbRe6n7kbQgPMEkARyex1.I9nRncfcgZ5TvkNYjYbcxqGTPCB5A9u','än\Õ-\‚\Á\Ë¸¥ÛÛ	ó®Ü\0','xµc=\Í\ÁõN∞º\Z\0\‹O˘','2017-03-07 23:07:40',37);
...
CREATE TABLE `user_events` (
  ...
  `rawContent` varchar(500) NOT NULL,
  `timestamp` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-12  0:00:57
