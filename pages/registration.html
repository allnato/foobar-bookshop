...
<html>
    ...
    <div class="wrapper container">
      <div class="register-wizard">
        <ul class="register-navigation">
          ...
          <li>
            <a href="#address-information" data-toggle="tab">
              <div class="nav-icon">
                <i class="fa fa-map-marker"></i>
                <p class="text-center">Address Information</p>
              </div>
            </a>
          </li>
          <li>
            <a href="#card-information" data-toggle="tab">
              <div class="nav-icon">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="address-information">
              <div class="address form-group has-feedback">
                ...
                <input type="text" name="b_address" class="form-control" id="b_address" placeholder="Home Address">
              </div>
              <div class="city form-group has-feedback">
                <label for="b_city">City</label>
                <input type="text" name="b_city" class="form-control" id="b_city" placeholder="ex. Manila">
              </div>
              <div class="zipcode form-group has-feedback">
                <label for="b_zipcode">Zipcode</label>
                <input type="text" name="b_zipcode" class="form-control" id="b_zipcode" placeholder="ex. 4103">
              </div>
              <div class="region form-group has-feedback">
                <label for="b_region">Region/Province/State</label>
                <input type="text" name="b_region" class="form-control" id="b_region" placeholder="ex. Texas">
              </div>
              <div class="country form-group has-feedback">
                <label for="b_country">Country</label>
                <select type="text" name="d_country" class="form-control" id="b_country">
              ...
              <div class="address form-group has-feedback">
                ...
                <input type="text" name="d_address" class="form-control" id="d_address" placeholder="Home Address">
              </div>
              <div class="city form-group has-feedback">
                <label for="d_city">City</label>
                <input type="text" name="d_city" class="form-control" id="d_city" placeholder="ex. Manila">
              </div>
              <div class="zipcode form-group has-feedback">
                <label for="d_zipcode">Zipcode</label>
                <input type="text" name="d_zipcode" class="form-control" id="d_zipcode" placeholder="ex. 4103">
              </div>
              <div class="region form-group has-feedback">
                <label for="d_region">Region</label>
                <input type="text" name="d_region" class="form-control" id="d_region" placeholder="ex. Texas">
              </div>
              <div class="country form-group has-feedback">
                <label for="d_country">Country</label>
                <select type="text" name="d_country" class="form-control" id="d_country">
                  <option value="AF">Afghanistan</option>
                	<option value="AX">Åland Islands</option>
                	<option value="AL">Albania</option>
                	<option value="DZ">Algeria</option>
            ...
            <div class="tab-pane" id="card-information">
              ...
              <div class="card_num form-group has-feedback">
                <label for="card_number">Card Number</label>
                <input type="text" name="cardNum" class="form-control" id="card_number" placeholder="ex. XXXX XXXX XXXX XXXX">
              </div>
              <div class="card_type form-group has-feedback">
                <label for="type">Type</label>
                <input type="text" name="cardType" class="form-control" id="card_type">
              </div>
  ...
  <script src="js/bootstrap.wizard.min.js" charset="utf-8"></script>
